...
public class IdentityFieldMapper extends IndivFieldMapper {
    ...
    private static final Pattern MULTI_NEW_LINES = Pattern.compile("(\r\n|[\n\r]+)(?: *)(?:(?:\r\n|[\n\r])+\\s*)+");
    ...
    private String compressNewLines(String v) {
        Matcher m = MULTI_NEW_LINES.matcher(v);
        v = m.replaceAll(MULTI_LINE_REPLACEMENT);
        return v;
    }
}
